...
const SingleProject = ({ project }) => {
  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col items-center justify-between w-full h-full' style={{ whiteSpace: 'pre-line' }}>
      ...
      <p className="absolute w-[90%] md:w-[85%] md:min-h-[150px] translate-x-[-110%] transition-transform duration-[0.9s] p-6 leading-[110%] rounded-[0_20px_20px_0] left-0 top-0 bg-[#0f0b24]  text-[#EFF3F4] translate-y-[25%] md:translate-y-[50%] group-hover:translate-x-[-2%] text-xs md:text-sm" style={{ whiteSpace: 'pre-line' }}>
        {description}
      </p>
